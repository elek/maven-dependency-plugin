...
public class TestBuildClasspathOldMojo
    extends AbstractDependencyMojoTestCase
{
        ...
        throws Exception
    {
        ...
        super.setUp( "build-classpath-comp", true );
    }
    ...
    public void testEnvironment()
        throws Exception
    {
        File testPom = new File( getBasedir(), "target/test-classes/unit/build-classpath-test-old/plugin-config.xml" );
        BuildClasspathOldMojo mojo = (BuildClasspathOldMojo) lookupMojo( "build-classpath-comp", testPom );
